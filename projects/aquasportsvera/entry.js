...
jQuery(function($) {
  ...
  $('#slider > div > div > div.owl-item.slider-item-visible > div > div.slider-slide-main > div > h4').html('<img src="http://aquasportsvera-es.alcandora.com/wp-content/uploads/2016/09/piscinagym.png"/>')
})
